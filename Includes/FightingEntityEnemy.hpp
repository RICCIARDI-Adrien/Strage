...
class FightingEntityEnemy: public FightingEntity
{
	...
	public:
		 ...
		 * @param facingUpMuzzleFlashTextureId The "facing up" texture of the muzzle flash generated by an entity shoot.
		 */
		FightingEntityEnemy(int x, int y, TextureManager::TextureId textureId, int movingPixelsAmount, int maximumLifePointsAmount, int timeBetweenShots, AudioManager::SoundId firingSoundId, TextureManager::TextureId bulletTextureId, TextureManager::TextureId facingUpMuzzleFlashTextureId): FightingEntity(x, y, textureId, movingPixelsAmount, maximumLifePointsAmount, timeBetweenShots, firingSoundId, bulletTextureId, facingUpMuzzleFlashTextureId)
		{
