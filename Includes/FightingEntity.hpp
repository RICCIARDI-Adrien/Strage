...
class FightingEntity: public MovingEntity
{
	...
	public:
		 ...
		 * @param explosionEffectId The effect to generate when the enemy explodes.
		 * @param facingUpMuzzleFlashTextureId The "facing up" texture of the muzzle flash generated by an entity shoot.
		 */
		FightingEntity(int x, int y, TextureManager::TextureId textureId, int movingPixelsAmount, int maximumLifePointsAmount, int timeBetweenShots, AudioManager::SoundId firingSoundId, TextureManager::TextureId facingUpBulletTextureId, TextureManager::TextureId facingUpMuzzleFlashTextureId): MovingEntity(x, y, textureId, movingPixelsAmount)
		{
			...
			_muzzleFlashFacingUpTextureId = facingUpMuzzleFlashTextureId;
