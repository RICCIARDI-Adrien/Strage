...
namespace AudioManager
{
	...
	typedef enum
	{
		...
		SOUND_ID_PLAYER_FIRESHOT_1,
		SOUND_ID_PLAYER_FIRESHOT_2,
		SOUND_ID_PLAYER_FIRESHOT_3,
		...
		SOUND_ID_SMALL_ENEMY_FIRESHOT_1,
		SOUND_ID_SMALL_ENEMY_FIRESHOT_2,
		SOUND_ID_SMALL_ENEMY_FIRESHOT_3,
